...
export default function Interviewinfo({navigation,route}) {
...
var Data ={
  ...
  return (
    ...
    <Text style={Universalstyles.text}><Icon name='currency-php' style={{fontSize: 20, color: 'red', }}/> {label.salary} {label.rate} </Text>
     ...
     {gets.post.map((label,index)=>(<View key={index} style={{height: 'auto', borderWidth: 2, borderColor: '#e8e8e8', borderRadius: 10, }}>
   ...
   <View style={{padding: 10, margin: 10, borderBottomWidth: 1, borderColor: '#cbc8ce'}}>
    ...
    <Text style={{ opacity: .5}}>04-22-22 <Text style={{color: 'green', textTransform: 'capitalize'}}></Text> </Text>
      ...
      <Text style={{color: 'green', fontSize: 20, marginHorizontal: 10}}>Approved</Text>
      <OptionsMenu
    ...
    borderRadius: 30,
      ...
      <Text style={{color: 'white', fontWeight: 'light', fontSize: 18}}>Set interview</Text>
      </View>
    </TouchableOpacity>
    </View>
   </ScrollView>
