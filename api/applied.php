...
WHERE userDetails.userID = apply.userID AND userDetails.userID = educationBG.userID AND userDetails.userID = guardian.userID AND userDetails.userID = address.userID AND apply.postID = 1 GROUP BY apply.userID";
