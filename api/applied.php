...
$select = "SELECT apply.applyID AS aid,apply.postID AS pid,apply.userID AS uid,apply.cor,apply.schoolid,apply.covlet,apply.appliedat,userDetails.*,educationBG.*,guardian.*,address.*,applicant.* FROM apply as app,userDetails,educationBG,guardian,address,apply
